 ...
 * is to create a class Prime which contains a single method checkPrime so that
 * the code prints only prime numbers as the output.
 * 
 * Please do not use method overloading!
 * 
 * Note: You may get a compile time error in this problem due to the below
 * statement:
 * 
