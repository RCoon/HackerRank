 ...
 * a=c and b=d. That also implies (a,b) is not same as (b,a). After taking each
 * pair as input, you need to print number of unique pairs you currently have.
 * 
 ...
 * of the next T lines will contain two strings separated by a single space.
 * 
 * Constraints:
 * 1<=T<=100000
