 ...
 * change c to d.
 * In order to form a palindrome, if he has to repeatedly reduce the value of a
 * letter, he can do it until the letter becomes a. Once a letter has been
 * changed to a, it can no longer be changed.
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numCases; i++) {
            ...
            for (int j = 0; j < length / 2; j++) {
                ...
                char right = input.charAt(length - 1 - j);
